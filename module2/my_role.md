...
#### 마이페이지 레이아웃 및 UX 설계
> ![마이페이지 메인 화면](./images/mypageMain.png)
...
* **지능형 자동 출결**: 별도의 버튼 없이 페이지 진입 시 로그인 기록을 대조하여 출결 데이터가 없을 경우 자동 출석 처리 (지각 회피 방지를 위한 로직 고도화 예정).
...
<sub>* 출결 현황 달력 화면 </sub>
> ![출결 현황 달력 화면](./images/attendanceCalendar.png)

<sub>* 관리자용 출결 수정 화면 </sub>
> ![관리자용 출결 수정 화면](./images/adminAttendanceEdit.png)
...
<sub>* 회원 탈퇴 확인 화면 </sub>
> ![회원 탈퇴 확인 화면](./images/userWithdraw.png)
