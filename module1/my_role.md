...
### 📐 복잡한 비즈니스 구현을 위한 다중 테이블 관계 분석
학생 메인 옵션 전반과 메시지, 성적 산출 등의 복합 제약사항을 데이터 정합성 깨짐 없이 구현하기 위해, 시스템 내 수많은 연관 테이블 구조와 외래키(FK) 참조 관계를 직접 분석하고 조인(`JOIN`) 쿼리를 설계하여 개발을 완수했습니다.

<p align="center">
  <img src="./images/module1ERD.png" width="90%" alt="모듈1 참조 ERD"><br>
  <sub>▲ 모듈 1 ERD: 적은 ERD 수를 유지하며 최대한 많은 기능 개발(6/6 테이블 참조)</sub>
</p>

* 모든 테이블을 참조한 만큼 전반적인 도메인에 대한 이해와 핵심 기능을 담당하여 시나리오에 맞는 더미 데이터 생성
